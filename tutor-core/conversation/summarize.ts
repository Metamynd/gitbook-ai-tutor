...
export async function summarizeConversation(
  ...
  const prompt = existingSummary
    ? `Existing summary of the conversation so far:\n${existingSummary}\n\nFold in these additional turns and produce one updated, concise summary (a few sentences — preserve topics discussed and any learner-stated goals or confusions):\n\n${transcript}`
    : `Summarize this conversation concisely (a few sentences — preserve topics discussed and any learner-stated goals or confusions):\n\n${transcript}`;
